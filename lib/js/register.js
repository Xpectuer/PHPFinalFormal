...
var validateName = function() {
    if (name_info.value === "") { //验证是否为空
        ...
        xhr.open("POST","checkRes.php",true);//JS文件的相对位置以引用他的html为准
        ...
        xhr.onload=function () {
            ...
            return true;
                ...
                name_p.innerText=xhr.responseText;
                name_p.style.color = "#888";
                name_info.style.border = "2px solid #888";
            }
        };
        xhr.send("username="+name_info.value);}
